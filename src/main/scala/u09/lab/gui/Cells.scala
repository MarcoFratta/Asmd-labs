...
import java.awt.{Color, Component, FlowLayout, GridLayout}
import javax.swing.{BorderFactory, Box, BoxLayout, JLabel, JPanel, SwingConstants}
import scala.swing.Dimension
import scala.u09.lab.gui.View.*
import scala.u09.lab.model.BasicMatrix.Move
import scala.u09.lab.model.ItemsMatrix.ItemsMatrix
import scala.u09.lab.model.{Enemies, Obstacles}
import scala.u09.lab.model.QMatrix.{Field, Pos2d}

object Cells:


  type Cell = JPanel => Unit
