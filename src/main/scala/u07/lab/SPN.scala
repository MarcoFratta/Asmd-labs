...
import scala.u06.lab.PetriNetModel.Transition.TransitionImpl
import scala.u06.lab.PetriNetModel.{PetriNet, Token, Transition}
...
object SPN:
  ...
  case class TrnWithRate[I,P](trn: Transition[I,P], rate: MSet[I] => Double)
